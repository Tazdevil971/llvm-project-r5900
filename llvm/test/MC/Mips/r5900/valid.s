...
foo:
    ...
    mult $3, $4      # CHECK: mult $zero, $3, $4  # encoding: [0x00,0x64,0x00,0x18]
    multu $3, $4     # CHECK: multu $zero, $3, $4 # encoding: [0x00,0x64,0x00,0x19]
    madd $2, $3, $4  # CHECK: madd $2, $3, $4     # encoding: [0x70,0x64,0x10,0x00]
    maddu $2, $3, $4 # CHECK: maddu $2, $3, $4    # encoding: [0x70,0x64,0x10,0x01]
    madd $3, $4      # CHECK: madd $zero, $3, $4  # encoding: [0x70,0x64,0x00,0x00]
    maddu $3, $4     # CHECK: maddu $zero, $3, $4 # encoding: [0x70,0x64,0x00,0x01]
    ...
    mult1 $3, $4      # CHECK: mult1 $zero, $3, $4  # encoding: [0x70,0x64,0x00,0x18]
    multu1 $3, $4     # CHECK: multu1 $zero, $3, $4 # encoding: [0x70,0x64,0x00,0x19]
    madd1 $2, $3, $4  # CHECK: madd1 $2, $3, $4     # encoding: [0x70,0x64,0x10,0x20]
    maddu1 $2, $3, $4 # CHECK: maddu1 $2, $3, $4    # encoding: [0x70,0x64,0x10,0x21]
    madd1 $3, $4      # CHECK: madd1 $zero, $3, $4  # encoding: [0x70,0x64,0x00,0x20]
    maddu1 $3, $4     # CHECK: maddu1 $zero, $3, $4 # encoding: [0x70,0x64,0x00,0x21]
    div1 $2, $3       # CHECK: div1 $zero, $2, $3   # encoding: [0x70,0x43,0x00,0x1a]
    divu1 $2, $3      # CHECK: divu1 $zero, $2, $3  # encoding: [0x70,0x43,0x00,0x1b]
    mtlo1 $2          # CHECK: mtlo1 $2             # encoding: [0x70,0x00,0x10,0x10]
    mthi1 $2          # CHECK: mthi1 $2             # encoding: [0x70,0x00,0x10,0x12]
    mflo1 $2          # CHECK: mflo1 $2             # encoding: [0x70,0x40,0x00,0x11]
    mfhi1 $2          # CHECK: mfhi1 $2             # encoding: [0x70,0x40,0x00,0x13]
