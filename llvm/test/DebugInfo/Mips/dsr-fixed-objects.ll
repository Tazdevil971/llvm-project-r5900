...
; CHECK-NEXT:   [0x00000028, 0x0000002c) ".text": DW_OP_reg1 AT_128
; CHECK-NEXT:   [0x0000002c, 0x00000048) ".text": DW_OP_breg29 SP_128+16)
...
; CHECK: DW_TAG_variable
; CHECK-NEXT: DW_AT_location [DW_FORM_sec_offset]  (
; CHECK-NEXT:   [0x00000080, 0x00000084) ".text": DW_OP_reg1 AT_128
; CHECK-NEXT:   [0x00000084, 0x00000098) ".text": DW_OP_breg29 SP_128+16)
; CHECK-NEXT: DW_AT_name [DW_FORM_strp]     ( .debug_str[0x0000006b] = "x")
